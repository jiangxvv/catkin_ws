...
"""autogenerated by genpy from usv_sim/PathPlannerActionFeedback.msg. Do not edit."""
import sys
...
class PathPlannerActionFeedback(genpy.Message):
  _md5sum = "7aae97d3f081b729c25e655e858353f1"
  _type = "usv_sim/PathPlannerActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','usv_sim/PathPlannerFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PathPlannerActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = usv_sim.msg.PathPlannerFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = usv_sim.msg.PathPlannerFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_d().pack(self.feedback.elapsed_time))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.elapsed_time,) = _get_struct_d().unpack(str[start:end])
      return self
