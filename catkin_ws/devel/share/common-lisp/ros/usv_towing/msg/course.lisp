...
(cl:defmethod cl:initialize-instance :after ((m <course>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'course)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name usv_towing-msg:<course> is deprecated: use usv_towing-msg:course instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <course>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usv_towing-msg:pose-val is deprecated.  Use usv_towing-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <course>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usv_towing-msg:velocity-val is deprecated.  Use usv_towing-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'acceleration-val :lambda-list '(m))
(cl:defmethod acceleration-val ((m <course>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usv_towing-msg:acceleration-val is deprecated.  Use usv_towing-msg:acceleration instead.")
  (acceleration m))
