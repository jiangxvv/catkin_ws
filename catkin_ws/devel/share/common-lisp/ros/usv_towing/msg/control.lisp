...
(cl:defmethod cl:initialize-instance :after ((m <control>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'control)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name usv_towing-msg:<control> is deprecated: use usv_towing-msg:control instead.")))

(cl:ensure-generic-function 'surge-val :lambda-list '(m))
(cl:defmethod surge-val ((m <control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usv_towing-msg:surge-val is deprecated.  Use usv_towing-msg:surge instead.")
  (surge m))

(cl:ensure-generic-function 'sway-val :lambda-list '(m))
(cl:defmethod sway-val ((m <control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usv_towing-msg:sway-val is deprecated.  Use usv_towing-msg:sway instead.")
  (sway m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usv_towing-msg:yaw-val is deprecated.  Use usv_towing-msg:yaw instead.")
  (yaw m))
