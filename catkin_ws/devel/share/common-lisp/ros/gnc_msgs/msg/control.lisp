...
(cl:defmethod cl:initialize-instance :after ((m <control>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'control)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gnc_msgs-msg:<control> is deprecated: use gnc_msgs-msg:control instead.")))

(cl:ensure-generic-function 'surge-val :lambda-list '(m))
(cl:defmethod surge-val ((m <control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnc_msgs-msg:surge-val is deprecated.  Use gnc_msgs-msg:surge instead.")
  (surge m))

(cl:ensure-generic-function 'sway-val :lambda-list '(m))
(cl:defmethod sway-val ((m <control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnc_msgs-msg:sway-val is deprecated.  Use gnc_msgs-msg:sway instead.")
  (sway m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gnc_msgs-msg:yaw-val is deprecated.  Use gnc_msgs-msg:yaw instead.")
  (yaw m))
