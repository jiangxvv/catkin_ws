...
class PathPlannerActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = PathPlannerFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PathPlannerActionFeedback(null);
    ...
    data.feedback = PathPlannerFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PathPlannerActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PathPlannerFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PathPlannerFeedback()
    }
...
module.exports = PathPlannerActionFeedback;
